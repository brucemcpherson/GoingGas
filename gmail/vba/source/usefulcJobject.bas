...
Public Function docToJobject(doc As Object, Optional complain As Boolean = True) As cJobject
    ...
    Dim node As Object, job As cJobject
    Set job = New cJobject
    job.Init Nothing
       
    Set docToJobject = handleNodes(doc, job)
End Function
Private Function isArrayRoot(parent As Object) As Boolean
    
    Dim node As Object, n As Long, node2 As Object
...
End Function
Private Function handleNodes(parent As Object, job As cJobject) As cJobject
    Dim node As Object, joc As cJobject, attrib As Object, i As Long, _
...
End Function
Private Function handleNode(node As Object, job As cJobject, Optional arrayHead As Boolean = False) As cJobject
    Dim Key As cJobject
